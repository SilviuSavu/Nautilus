          ...
          <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
            <Col xs={24} sm={8}>
              <Statistic
                ...
                prefix={positionSummary.pnl.unrealizedPnl >= 0 ? <TrendingUpOutlined /> : <TrendingDownOutlined />}
            ...
            <Col xs={24} sm={8}>
              <Statistic
                ...
                formatter={(value) => formatCurrency(Number(value))}
                prefix={positionSummary.pnl.totalPnl >= 0 ? <TrendingUpOutlined /> : <TrendingDownOutlined />}
