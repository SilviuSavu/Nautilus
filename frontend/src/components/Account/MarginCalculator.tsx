...
import { Card, Row, Col, Statistic, Progress, Alert, Space, Typography, Slider, InputNumber, Button } from 'antd';
import { 
  CalculatorOutlined, 
  WarningOutlined, 
  InfoCircleOutlined,
...
export const MarginCalculator: React.FC<MarginCalculatorProps> = ({ className }) => {
  const { accountBalances, positionSummary } = usePositionData();
